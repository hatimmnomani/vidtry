...
__export(arrow_left_exports, {
  default: () => exports.arrowLeftPaths
});
exports.arrowLeftPaths = void 0;
var init_arrow_left = __esm({
  "src/icons/arrow-left.ts"() {
    exports.arrowLeftPaths = `<path d="M13.0908 14.3334C12.972 14.3334 12.9125 14.1898 12.9965 14.1058L17.7021 9.40022C17.9625 9.13987 17.9625 8.71776 17.7021 8.45741L16.2879 7.04319C16.0275 6.78284 15.6054 6.78284 15.3451 7.04319L6.8598 15.5285C6.59945 15.7888 6.59945 16.2109 6.8598 16.4713L8.27401 17.8855L8.27536 17.8868L15.3453 24.9568C15.6057 25.2172 16.0278 25.2172 16.2881 24.9568L17.7024 23.5426C17.9627 23.2822 17.9627 22.8601 17.7024 22.5998L12.9969 17.8944C12.9129 17.8104 12.9724 17.6668 13.0912 17.6668L26 17.6668C26.3682 17.6668 26.6667 17.3683 26.6667 17.0001V15.0001C26.6667 14.6319 26.3682 14.3334 26 14.3334L13.0908 14.3334Z" fill="currentColor"/>`;
  }
});
...
__export(chevron_down_exports, {
  default: () => exports.chevronDownPaths
});
exports.chevronDownPaths = void 0;
var init_chevron_down = __esm({
  "src/icons/chevron-down.ts"() {
    exports.chevronDownPaths = `<path d="M15.905 17.4809C15.9571 17.533 16.0415 17.533 16.0936 17.4809L22.4111 11.1635C22.6714 10.9031 23.0935 10.9031 23.3539 11.1635L24.9567 12.7662C25.217 13.0266 25.217 13.4487 24.9567 13.709L18.1028 20.5629C18.0937 20.5732 18.0842 20.5833 18.0744 20.5931L16.4716 22.1959C16.2113 22.4562 15.7892 22.4562 15.5288 22.1959L7.04353 13.7106C6.78318 13.4503 6.78318 13.0281 7.04353 12.7678L8.6463 11.165C8.90665 10.9047 9.32876 10.9047 9.58911 11.165L15.905 17.4809Z" fill="currentColor"/>`;
  }
});
...
__export(chevron_right_exports, {
  default: () => exports.chevronRightPaths
});
exports.chevronRightPaths = void 0;
var init_chevron_right = __esm({
  "src/icons/chevron-right.ts"() {
    exports.chevronRightPaths = `<path d="M17.947 16.095C17.999 16.043 17.999 15.9585 17.947 15.9065L11.6295 9.58899C11.3691 9.32864 11.3691 8.90653 11.6295 8.64618L13.2323 7.04341C13.4926 6.78306 13.9147 6.78306 14.1751 7.04341L21.0289 13.8973C21.0392 13.9064 21.0493 13.9158 21.0591 13.9257L22.6619 15.5285C22.9223 15.7888 22.9223 16.2109 22.6619 16.4713L14.1766 24.9565C13.9163 25.2169 13.4942 25.2169 13.2338 24.9565L11.631 23.3538C11.3707 23.0934 11.3707 22.6713 11.631 22.411L17.947 16.095Z" fill="currentColor"/>`;
  }
});

// src/icons/chromecast.ts
var chromecast_exports = {};
__export(chromecast_exports, {
  default: () => exports.chromecastPaths
});
exports.chromecastPaths = void 0;
var init_chromecast = __esm({
  "src/icons/chromecast.ts"() {
    exports.chromecastPaths = `<path fill-rule="evenodd" clip-rule="evenodd" d="M6 7C5.63181 7 5.33333 7.29848 5.33333 7.66667V14.8667C5.33333 14.9403 5.39361 14.9999 5.46724 15.0009C10.8844 15.0719 15.2614 19.449 15.3325 24.8661C15.3334 24.9397 15.393 25 15.4667 25H26C26.3682 25 26.6667 24.7015 26.6667 24.3333V7.66667C26.6667 7.29848 26.3682 7 26 7H6ZM17.0119 22.2294C17.0263 22.29 17.0802 22.3333 17.1425 22.3333H23.3333C23.7015 22.3333 24 22.0349 24 21.6667V10.3333C24 9.96514 23.7015 9.66667 23.3333 9.66667H8.66667C8.29848 9.66667 8 9.96514 8 10.3333V13.1909C8 13.2531 8.04332 13.3071 8.10392 13.3214C12.5063 14.3618 15.9715 17.827 17.0119 22.2294Z" fill="currentColor"/> <path d="M13.2 25C13.2736 25 13.3334 24.9398 13.3322 24.8661C13.2615 20.5544 9.77889 17.0718 5.46718 17.0011C5.39356 16.9999 5.33333 17.0597 5.33333 17.1333V18.8667C5.33333 18.9403 5.39348 18.9999 5.4671 19.0015C8.67465 19.0716 11.2617 21.6587 11.3319 24.8662C11.3335 24.9399 11.393 25 11.4667 25H13.2Z" fill="currentColor"/> <path d="M5.33333 21.1333C5.33333 21.0597 5.39332 20.9998 5.46692 21.0022C7.57033 21.0712 9.26217 22.763 9.33114 24.8664C9.33356 24.94 9.27364 25 9.2 25H6C5.63181 25 5.33333 24.7015 5.33333 24.3333V21.1333Z" fill="currentColor"/>`;
  }
});
...
__export(computer_exports, {
  default: () => exports.computerPaths
});
exports.computerPaths = void 0;
var init_computer = __esm({
  "src/icons/computer.ts"() {
    exports.computerPaths = `<path fill-rule="evenodd" clip-rule="evenodd" d="M5.33334 6.00001C5.33334 5.63182 5.63182 5.33334 6.00001 5.33334H26C26.3682 5.33334 26.6667 5.63182 26.6667 6.00001V20.6667C26.6667 21.0349 26.3682 21.3333 26 21.3333H6.00001C5.63182 21.3333 5.33334 21.0349 5.33334 20.6667V6.00001ZM8.40008 9.06634C8.40008 8.69815 8.69855 8.39967 9.06674 8.39967H22.9339C23.3021 8.39967 23.6006 8.69815 23.6006 9.06634V17.6002C23.6006 17.9684 23.3021 18.2669 22.9339 18.2669H9.06674C8.69855 18.2669 8.40008 17.9684 8.40008 17.6002V9.06634Z" fill="currentColor"/> <path d="M6.00001 23.9999C5.63182 23.9999 5.33334 24.2984 5.33334 24.6666V25.9999C5.33334 26.3681 5.63182 26.6666 6.00001 26.6666H26C26.3682 26.6666 26.6667 26.3681 26.6667 25.9999V24.6666C26.6667 24.2984 26.3682 23.9999 26 23.9999H6.00001Z" fill="currentColor"/>`;
  }
});
...
__export(eye_exports, {
  default: () => exports.eyePaths
});
exports.eyePaths = void 0;
var init_eye = __esm({
  "src/icons/eye.ts"() {
    exports.eyePaths = `<path d="M16 20C18.2091 20 20 18.2092 20 16C20 13.7909 18.2091 12 16 12C13.7909 12 12 13.7909 12 16C12 18.2092 13.7909 20 16 20Z" fill="currentColor"/> <path fill-rule="evenodd" clip-rule="evenodd" d="M28 16.0058C28 18.671 23.5 25.3334 16 25.3334C8.5 25.3334 4 18.6762 4 16.0058C4 13.3354 8.50447 6.66669 16 6.66669C23.4955 6.66669 28 13.3406 28 16.0058ZM25.3318 15.9934C25.3328 16.0017 25.3328 16.0099 25.3318 16.0182C25.3274 16.0571 25.3108 16.1728 25.2485 16.3708C25.1691 16.6229 25.0352 16.9462 24.8327 17.3216C24.4264 18.0749 23.7969 18.9398 22.9567 19.754C21.2791 21.3798 18.9148 22.6667 16 22.6667C13.0845 22.6667 10.7202 21.3805 9.04298 19.7557C8.20295 18.9419 7.57362 18.0773 7.16745 17.3241C6.96499 16.9486 6.83114 16.6252 6.75172 16.3729C6.67942 16.1431 6.66856 16.0243 6.66695 16.0066L6.66695 16.005C6.66859 15.9871 6.67951 15.8682 6.75188 15.6383C6.83145 15.3854 6.96554 15.0614 7.16831 14.6853C7.57507 13.9306 8.20514 13.0644 9.04577 12.249C10.7245 10.6208 13.0886 9.33335 16 9.33335C18.9108 9.33335 21.2748 10.6215 22.9539 12.2507C23.7947 13.0664 24.4249 13.933 24.8318 14.6877C25.0346 15.0639 25.1688 15.3878 25.2483 15.6404C25.3107 15.8386 25.3274 15.9545 25.3318 15.9934Z" fill="currentColor"/>`;
  }
});

// src/icons/fast-backward.ts
var fast_backward_exports = {};
__export(fast_backward_exports, {
  default: () => exports.fastBackwardPaths
});
exports.fastBackwardPaths = void 0;
var init_fast_backward = __esm({
  "src/icons/fast-backward.ts"() {
    exports.fastBackwardPaths = `<path d="M15.8747 8.11857C16.3148 7.79342 16.9375 8.10759 16.9375 8.65476V14.2575C16.9375 14.3669 17.0621 14.4297 17.1501 14.3647L25.6038 8.11857C26.0439 7.79342 26.6667 8.10759 26.6667 8.65476V23.3451C26.6667 23.8923 26.0439 24.2064 25.6038 23.8813L17.1501 17.6346C17.0621 17.5695 16.9375 17.6324 16.9375 17.7418L16.9375 23.3451C16.9375 23.8923 16.3147 24.2064 15.8747 23.8813L5.93387 16.5358C5.57322 16.2693 5.57323 15.7299 5.93389 15.4634L15.8747 8.11857Z" fill="currentColor"/>`;
  }
});
...
__export(fast_forward_exports, {
  default: () => exports.fastForwardPaths
});
exports.fastForwardPaths = void 0;
var init_fast_forward = __esm({
  "src/icons/fast-forward.ts"() {
    exports.fastForwardPaths = `<path d="M16.1253 8.11866C15.6852 7.7935 15.0625 8.10768 15.0625 8.65484V14.2576C15.0625 14.367 14.9379 14.4298 14.8499 14.3648L6.39615 8.11866C5.95607 7.7935 5.33331 8.10768 5.33331 8.65484V23.3452C5.33331 23.8923 5.9561 24.2065 6.39617 23.8813L14.8499 17.6347C14.9379 17.5696 15.0625 17.6325 15.0625 17.7419L15.0625 23.3452C15.0625 23.8923 15.6853 24.2065 16.1253 23.8813L26.0661 16.5358C26.4268 16.2694 26.4268 15.73 26.0661 15.4635L16.1253 8.11866Z" fill="currentColor"/>`;
  }
});
...
__export(mobile_exports, {
  default: () => exports.mobilePaths
});
exports.mobilePaths = void 0;
...
__export(next_exports, {
  default: () => exports.nextPaths
});
exports.nextPaths = void 0;
var init_next = __esm({
  "src/icons/next.ts"() {
...
__export(pause_exports, {
  default: () => exports.pausePaths
});
exports.pausePaths = void 0;
var init_pause = __esm({
  "src/icons/pause.ts"() {
    exports.pausePaths = `<path d="M8.66667 6.66667C8.29848 6.66667 8 6.96514 8 7.33333V24.6667C8 25.0349 8.29848 25.3333 8.66667 25.3333H12.6667C13.0349 25.3333 13.3333 25.0349 13.3333 24.6667V7.33333C13.3333 6.96514 13.0349 6.66667 12.6667 6.66667H8.66667Z" fill="currentColor"/> <path d="M19.3333 6.66667C18.9651 6.66667 18.6667 6.96514 18.6667 7.33333V24.6667C18.6667 25.0349 18.9651 25.3333 19.3333 25.3333H23.3333C23.7015 25.3333 24 25.0349 24 24.6667V7.33333C24 6.96514 23.7015 6.66667 23.3333 6.66667H19.3333Z" fill="currentColor"/>`;
  }
});

// src/icons/picture-in-picture-exit.ts
var picture_in_picture_exit_exports = {};
__export(picture_in_picture_exit_exports, {
  default: () => exports.pictureInPictureExitPaths
});
exports.pictureInPictureExitPaths = void 0;
var init_picture_in_picture_exit = __esm({
  "src/icons/picture-in-picture-exit.ts"() {
    exports.pictureInPictureExitPaths = `<path d="M5.33334 26V19.4667C5.33334 19.393 5.39304 19.3333 5.46668 19.3333H7.86668C7.94031 19.3333 8.00001 19.393 8.00001 19.4667V23.3333C8.00001 23.7015 8.29849 24 8.66668 24H23.3333C23.7015 24 24 23.7015 24 23.3333V8.66666C24 8.29847 23.7015 7.99999 23.3333 7.99999H19.4667C19.393 7.99999 19.3333 7.9403 19.3333 7.86666V5.46666C19.3333 5.39302 19.393 5.33333 19.4667 5.33333H26C26.3682 5.33333 26.6667 5.63181 26.6667 5.99999V26C26.6667 26.3682 26.3682 26.6667 26 26.6667H6.00001C5.63182 26.6667 5.33334 26.3682 5.33334 26Z" fill="currentColor"/> <path d="M14.0098 8.42359H10.806C10.6872 8.42359 10.6277 8.56721 10.7117 8.6512L16.5491 14.4886C16.8094 14.7489 16.8094 15.171 16.5491 15.4314L15.3234 16.657C15.0631 16.9174 14.641 16.9174 14.3806 16.657L8.63739 10.9138C8.55339 10.8298 8.40978 10.8893 8.40978 11.0081V14.0236C8.40978 14.3918 8.1113 14.6903 7.74311 14.6903H6.00978C5.64159 14.6903 5.34311 14.3918 5.34311 14.0236L5.34311 6.02359C5.34311 5.6554 5.64159 5.35692 6.00978 5.35692L14.0098 5.35692C14.378 5.35692 14.6764 5.6554 14.6764 6.02359V7.75692C14.6764 8.12511 14.378 8.42359 14.0098 8.42359Z" fill="currentColor"/>`;
  }
});
...
__export(picture_in_picture_exports, {
  default: () => exports.pictureInPicturePaths
});
exports.pictureInPicturePaths = void 0;
var init_picture_in_picture = __esm({
  "src/icons/picture-in-picture.ts"() {
    exports.pictureInPicturePaths = `<path d="M16 15.3333C15.6318 15.3333 15.3333 15.6318 15.3333 16V20C15.3333 20.3682 15.6318 20.6667 16 20.6667H21.3333C21.7015 20.6667 22 20.3682 22 20V16C22 15.6318 21.7015 15.3333 21.3333 15.3333H16Z" fill="currentColor"/> <path fill-rule="evenodd" clip-rule="evenodd" d="M5.33333 7.33334C5.33333 6.96515 5.63181 6.66667 5.99999 6.66667H26C26.3682 6.66667 26.6667 6.96515 26.6667 7.33334V24.6667C26.6667 25.0349 26.3682 25.3333 26 25.3333H5.99999C5.63181 25.3333 5.33333 25.0349 5.33333 24.6667V7.33334ZM7.99999 10C7.99999 9.63182 8.29847 9.33334 8.66666 9.33334H23.3333C23.7015 9.33334 24 9.63182 24 10V22C24 22.3682 23.7015 22.6667 23.3333 22.6667H8.66666C8.29847 22.6667 7.99999 22.3682 7.99999 22V10Z" fill="currentColor"/>`;
  }
});
...
__export(play_exports, {
  default: () => exports.playPaths
});
exports.playPaths = void 0;
var init_play = __esm({
  "src/icons/play.ts"() {
    exports.playPaths = `<path d="M10.6667 6.6548C10.6667 6.10764 11.2894 5.79346 11.7295 6.11862L24.377 15.4634C24.7377 15.7298 24.7377 16.2692 24.3771 16.5357L11.7295 25.8813C11.2895 26.2065 10.6667 25.8923 10.6667 25.3451L10.6667 6.6548Z" fill="currentColor"/>`;
  }
});

// src/icons/playback-speed-circle.ts
var playback_speed_circle_exports = {};
__export(playback_speed_circle_exports, {
  default: () => exports.playbackSpeedCirclePaths
});
exports.playbackSpeedCirclePaths = void 0;
var init_playback_speed_circle = __esm({
  "src/icons/playback-speed-circle.ts"() {
    exports.playbackSpeedCirclePaths = `<path d="M13.9213 5.53573C14.3146 5.45804 14.6666 5.76987 14.6666 6.17079V7.57215C14.6666 7.89777 14.4305 8.17277 14.114 8.24925C12.5981 8.61559 11.2506 9.41368 10.2091 10.506C9.98474 10.7414 9.62903 10.8079 9.34742 10.6453L8.14112 9.94885C7.79394 9.7484 7.69985 9.28777 7.96359 8.98585C9.48505 7.24409 11.5636 6.00143 13.9213 5.53573Z" fill="currentColor"/> <path d="M5.88974 12.5908C6.01805 12.2101 6.46491 12.0603 6.81279 12.2611L8.01201 12.9535C8.29379 13.1162 8.41396 13.4577 8.32238 13.7699C8.11252 14.4854 7.99998 15.2424 7.99998 16.0257C7.99998 16.809 8.11252 17.566 8.32238 18.2814C8.41396 18.5936 8.29378 18.9352 8.01201 19.0979L6.82742 19.7818C6.48051 19.9821 6.03488 19.8337 5.90521 19.4547C5.5345 18.3712 5.33331 17.2091 5.33331 16C5.33331 14.8078 5.5289 13.6613 5.88974 12.5908Z" fill="currentColor"/> <path d="M8.17106 22.0852C7.82291 22.2862 7.72949 22.7486 7.99532 23.0502C9.51387 24.773 11.5799 26.0017 13.9213 26.4642C14.3146 26.5419 14.6666 26.2301 14.6666 25.8291V24.4792C14.6666 24.1536 14.4305 23.8786 14.114 23.8021C12.5981 23.4358 11.2506 22.6377 10.2091 21.5453C9.98474 21.31 9.62903 21.2435 9.34742 21.4061L8.17106 22.0852Z" fill="currentColor"/> <path d="M17.3333 25.8291C17.3333 26.2301 17.6857 26.5418 18.079 26.4641C22.9748 25.4969 26.6666 21.1796 26.6666 16C26.6666 10.8204 22.9748 6.50302 18.079 5.5358C17.6857 5.4581 17.3333 5.76987 17.3333 6.17079V7.57215C17.3333 7.89777 17.5697 8.17282 17.8862 8.24932C21.3942 9.09721 24 12.2572 24 16.0257C24 19.7942 21.3942 22.9542 17.8862 23.802C17.5697 23.8785 17.3333 24.1536 17.3333 24.4792V25.8291Z" fill="currentColor"/> <path d="M14.3961 10.4163C13.9561 10.0911 13.3333 10.4053 13.3333 10.9525L13.3333 21.0474C13.3333 21.5946 13.9561 21.9087 14.3962 21.5836L21.2273 16.5359C21.5879 16.2694 21.5879 15.73 21.2273 15.4635L14.3961 10.4163Z" fill="currentColor"/>`;
  }
});
...
__export(replay_exports, {
  default: () => exports.replayPaths
});
exports.replayPaths = void 0;
var init_replay = __esm({
  "src/icons/replay.ts"() {
    exports.replayPaths = `<path d="M15.6038 12.2147C16.0439 12.5399 16.6667 12.2257 16.6667 11.6786V10.1789C16.6667 10.1001 16.7351 10.0384 16.8134 10.0479C20.1116 10.4494 22.6667 13.2593 22.6667 16.6659C22.6667 20.3481 19.6817 23.3332 15.9995 23.3332C12.542 23.3332 9.69927 20.7014 9.36509 17.332C9.32875 16.9655 9.03371 16.6662 8.66548 16.6662L6.66655 16.6666C6.29841 16.6666 5.99769 16.966 6.02187 17.3334C6.36494 22.5454 10.7012 26.6667 16 26.6667C21.5228 26.6667 26 22.1895 26 16.6667C26 11.4103 21.9444 7.10112 16.7916 6.69757C16.7216 6.69209 16.6667 6.63396 16.6667 6.56372V4.98824C16.6667 4.44106 16.0439 4.12689 15.6038 4.45206L11.0765 7.79738C10.7159 8.06387 10.7159 8.60326 11.0766 8.86973L15.6038 12.2147Z" fill="currentColor"/>`;
  }
});
...
__export(send_exports, {
  default: () => exports.sendPaths
});
exports.sendPaths = void 0;
var init_send = __esm({
  "src/icons/send.ts"() {
...
__export(stop_exports, {
  default: () => exports.stopPaths
});
exports.stopPaths = void 0;
var init_stop = __esm({
  "src/icons/stop.ts"() {
    exports.stopPaths = `<path d="M8.66667 8C8.29848 8 8 8.29848 8 8.66667V23.3333C8 23.7015 8.29848 24 8.66667 24H23.3333C23.7015 24 24 23.7015 24 23.3333V8.66667C24 8.29848 23.7015 8 23.3333 8H8.66667Z" fill="currentColor"/>`;
  }
});
...
var tv_exports = {};
__export(tv_exports, {
  default: () => exports.tvPaths
});
exports.tvPaths = void 0;
var init_tv = __esm({
  "src/icons/tv.ts"() {
    exports.tvPaths = `<path fill-rule="evenodd" clip-rule="evenodd" d="M5.33334 6.00001C5.33334 5.63182 5.63182 5.33334 6.00001 5.33334H26C26.3682 5.33334 26.6667 5.63182 26.6667 6.00001V20.6667C26.6667 21.0349 26.3682 21.3333 26 21.3333H6.00001C5.63182 21.3333 5.33334 21.0349 5.33334 20.6667V6.00001ZM8.40008 9.06634C8.40008 8.69815 8.69855 8.39967 9.06674 8.39967H22.9339C23.3021 8.39967 23.6006 8.69815 23.6006 9.06634V17.6002C23.6006 17.9684 23.3021 18.2669 22.9339 18.2669H9.06674C8.69855 18.2669 8.40008 17.9684 8.40008 17.6002V9.06634Z" fill="currentColor"/> <path d="M11.3333 23.9999C10.9652 23.9999 10.6667 24.2984 10.6667 24.6666V25.9999C10.6667 26.3681 10.9652 26.6666 11.3333 26.6666H20.6667C21.0349 26.6666 21.3333 26.3681 21.3333 25.9999V24.6666C21.3333 24.2984 21.0349 23.9999 20.6667 23.9999H11.3333Z" fill="currentColor"/>`;
  }
});
...
init_add();
init_airplay();
init_arrow_collapse_in();
init_arrow_collapse();
init_arrow_expand_out();
init_arrow_expand();
init_arrow_left();
init_bookmark();
init_camera();
...
init_chromecast();
init_clip();
init_closed_captions_on();
init_closed_captions();
init_comment();
init_computer();
init_device();
init_download();
...
init_fast_forward();
init_flag();
init_fullscreen_arrow_exit();
init_fullscreen_arrow();
init_fullscreen_exit();
init_fullscreen();
init_heart();
init_info();
init_language();
...
init_odometer();
init_pause();
init_picture_in_picture_exit();
init_picture_in_picture();
init_play();
init_playback_speed_circle();
init_playlist();
init_previous();
init_question_mark();
init_queue_list();
init_radio_button_selected();
init_radio_button();
init_repeat_on();
init_repeat_square_on();
init_repeat_square();
init_repeat();
init_replay();
init_rotate();
init_search();
init_seek_backward_10();
init_seek_backward_15();
init_seek_backward_30();
init_seek_backward();
init_seek_forward_10();
init_seek_forward_15();
init_seek_forward_30();
init_seek_forward();
init_send();
init_settings_menu();
...
init_x_mark();
var paths = {
  "add-note": exports.addNotePaths,
  "add-playlist": exports.addPlaylistPaths,
  "add-user": exports.addUserPaths,
  "add": exports.addPaths,
  "airplay": exports.airplayPaths,
  "arrow-collapse-in": exports.arrowCollapseInPaths,
  "arrow-collapse": exports.arrowCollapsePaths,
  "arrow-expand-out": exports.arrowExpandOutPaths,
  "arrow-expand": exports.arrowExpandPaths,
  "arrow-left": exports.arrowLeftPaths,
  "bookmark": exports.bookmarkPaths,
  "camera": exports.cameraPaths,
  "chapters": exports.chaptersPaths,
  "chat-collapse": exports.chatCollapsePaths,
  "chat": exports.chatPaths,
  "chevron-down": exports.chevronDownPaths,
  "chevron-right": exports.chevronRightPaths,
  "chromecast": exports.chromecastPaths,
  "clip": exports.clipPaths,
  "closed-captions-on": exports.closedCaptionsOnPaths,
  "closed-captions": exports.closedCaptionsPaths,
  "comment": exports.commentPaths,
  "computer": exports.computerPaths,
  "device": exports.devicePaths,
  "download": exports.downloadPaths,
  "episodes": exports.episodesPaths,
  "eye": exports.eyePaths,
  "fast-backward": exports.fastBackwardPaths,
  "fast-forward": exports.fastForwardPaths,
  "flag": exports.flagPaths,
  "fullscreen-arrow-exit": exports.fullscreenArrowExitPaths,
  "fullscreen-arrow": exports.fullscreenArrowPaths,
  "fullscreen-exit": exports.fullscreenExitPaths,
  "fullscreen": exports.fullscreenPaths,
  "heart": exports.heartPaths,
  "info": exports.infoPaths,
  "language": exports.languagePaths,
  "link": exports.linkPaths,
  "lock-closed": exports.lockClosedPaths,
  "lock-open": exports.lockOpenPaths,
  "menu-horizontal": exports.menuHorizontalPaths,
  "menu-vertical": exports.menuVerticalPaths,
  "microphone": exports.microphonePaths,
  "mobile": exports.mobilePaths,
  "moon": exports.moonPaths,
  "music-off": exports.musicOffPaths,
  "music": exports.musicPaths,
  "mute": exports.mutePaths,
  "next": exports.nextPaths,
  "notification": exports.notificationPaths,
  "odometer": exports.odometerPaths,
  "pause": exports.pausePaths,
  "picture-in-picture-exit": exports.pictureInPictureExitPaths,
  "picture-in-picture": exports.pictureInPicturePaths,
  "play": exports.playPaths,
  "playback-speed-circle": exports.playbackSpeedCirclePaths,
  "playlist": exports.playlistPaths,
  "previous": exports.previousPaths,
  "question-mark": exports.questionMarkPaths,
  "queue-list": exports.queueListPaths,
  "radio-button-selected": exports.radioButtonSelectedPaths,
  "radio-button": exports.radioButtonPaths,
  "repeat-on": exports.repeatOnPaths,
  "repeat-square-on": exports.repeatSquareOnPaths,
  "repeat-square": exports.repeatSquarePaths,
  "repeat": exports.repeatPaths,
  "replay": exports.replayPaths,
  "rotate": exports.rotatePaths,
  "search": exports.searchPaths,
  "seek-backward-10": exports.seekBackward10Paths,
  "seek-backward-15": exports.seekBackward15Paths,
  "seek-backward-30": exports.seekBackward30Paths,
  "seek-backward": exports.seekBackwardPaths,
  "seek-forward-10": exports.seekForward10Paths,
  "seek-forward-15": exports.seekForward15Paths,
  "seek-forward-30": exports.seekForward30Paths,
  "seek-forward": exports.seekForwardPaths,
  "send": exports.sendPaths,
  "settings-menu": exports.settingsMenuPaths,
  "settings-switch": exports.settingsSwitchPaths,
  "settings": exports.settingsPaths,
  "share-arrow": exports.shareArrowPaths,
  "share": exports.sharePaths,
  "shuffle-on": exports.shuffleOnPaths,
  "shuffle": exports.shufflePaths,
  "stop": exports.stopPaths,
  "subtitles": exports.subtitlesPaths,
  "sun": exports.sunPaths,
  "theatre-mode-exit": exports.theatreModeExitPaths,
  "theatre-mode": exports.theatreModePaths,
  "thumbs-down": exports.thumbsDownPaths,
  "thumbs-up": exports.thumbsUpPaths,
  "timer": exports.timerPaths,
  "transcript": exports.transcriptPaths,
  "tv": exports.tvPaths,
  "user": exports.userPaths,
  "volume-high": exports.volumeHighPaths,
  "volume-low": exports.volumeLowPaths,
  "x-mark": exports.xMarkPaths
};
var lazyPaths = {
  "add-note": () => Promise.resolve().then(() => (init_add_note(), add_note_exports)),
  "add-playlist": () => Promise.resolve().then(() => (init_add_playlist(), add_playlist_exports)),
  "add-user": () => Promise.resolve().then(() => (init_add_user(), add_user_exports)),
  "add": () => Promise.resolve().then(() => (init_add(), add_exports)),
  "airplay": () => Promise.resolve().then(() => (init_airplay(), airplay_exports)),
  "arrow-collapse-in": () => Promise.resolve().then(() => (init_arrow_collapse_in(), arrow_collapse_in_exports)),
  "arrow-collapse": () => Promise.resolve().then(() => (init_arrow_collapse(), arrow_collapse_exports)),
  "arrow-expand-out": () => Promise.resolve().then(() => (init_arrow_expand_out(), arrow_expand_out_exports)),
  "arrow-expand": () => Promise.resolve().then(() => (init_arrow_expand(), arrow_expand_exports)),
  "arrow-left": () => Promise.resolve().then(() => (init_arrow_left(), arrow_left_exports)),
  "bookmark": () => Promise.resolve().then(() => (init_bookmark(), bookmark_exports)),
  "camera": () => Promise.resolve().then(() => (init_camera(), camera_exports)),
  "chapters": () => Promise.resolve().then(() => (init_chapters(), chapters_exports)),
  "chat-collapse": () => Promise.resolve().then(() => (init_chat_collapse(), chat_collapse_exports)),
  "chat": () => Promise.resolve().then(() => (init_chat(), chat_exports)),
  "chevron-down": () => Promise.resolve().then(() => (init_chevron_down(), chevron_down_exports)),
  "chevron-right": () => Promise.resolve().then(() => (init_chevron_right(), chevron_right_exports)),
  "chromecast": () => Promise.resolve().then(() => (init_chromecast(), chromecast_exports)),
  "clip": () => Promise.resolve().then(() => (init_clip(), clip_exports)),
  "closed-captions-on": () => Promise.resolve().then(() => (init_closed_captions_on(), closed_captions_on_exports)),
  "closed-captions": () => Promise.resolve().then(() => (init_closed_captions(), closed_captions_exports)),
  "comment": () => Promise.resolve().then(() => (init_comment(), comment_exports)),
  "computer": () => Promise.resolve().then(() => (init_computer(), computer_exports)),
  "device": () => Promise.resolve().then(() => (init_device(), device_exports)),
  "download": () => Promise.resolve().then(() => (init_download(), download_exports)),
  "episodes": () => Promise.resolve().then(() => (init_episodes(), episodes_exports)),
  "eye": () => Promise.resolve().then(() => (init_eye(), eye_exports)),
  "fast-backward": () => Promise.resolve().then(() => (init_fast_backward(), fast_backward_exports)),
  "fast-forward": () => Promise.resolve().then(() => (init_fast_forward(), fast_forward_exports)),
  "flag": () => Promise.resolve().then(() => (init_flag(), flag_exports)),
  "fullscreen-arrow-exit": () => Promise.resolve().then(() => (init_fullscreen_arrow_exit(), fullscreen_arrow_exit_exports)),
  "fullscreen-arrow": () => Promise.resolve().then(() => (init_fullscreen_arrow(), fullscreen_arrow_exports)),
  "fullscreen-exit": () => Promise.resolve().then(() => (init_fullscreen_exit(), fullscreen_exit_exports)),
  "fullscreen": () => Promise.resolve().then(() => (init_fullscreen(), fullscreen_exports)),
  "heart": () => Promise.resolve().then(() => (init_heart(), heart_exports)),
  "info": () => Promise.resolve().then(() => (init_info(), info_exports)),
  "language": () => Promise.resolve().then(() => (init_language(), language_exports)),
  "link": () => Promise.resolve().then(() => (init_link(), link_exports)),
  "lock-closed": () => Promise.resolve().then(() => (init_lock_closed(), lock_closed_exports)),
  "lock-open": () => Promise.resolve().then(() => (init_lock_open(), lock_open_exports)),
  "menu-horizontal": () => Promise.resolve().then(() => (init_menu_horizontal(), menu_horizontal_exports)),
  "menu-vertical": () => Promise.resolve().then(() => (init_menu_vertical(), menu_vertical_exports)),
  "microphone": () => Promise.resolve().then(() => (init_microphone(), microphone_exports)),
  "mobile": () => Promise.resolve().then(() => (init_mobile(), mobile_exports)),
  "moon": () => Promise.resolve().then(() => (init_moon(), moon_exports)),
  "music-off": () => Promise.resolve().then(() => (init_music_off(), music_off_exports)),
  "music": () => Promise.resolve().then(() => (init_music(), music_exports)),
  "mute": () => Promise.resolve().then(() => (init_mute(), mute_exports)),
  "next": () => Promise.resolve().then(() => (init_next(), next_exports)),
  "notification": () => Promise.resolve().then(() => (init_notification(), notification_exports)),
  "odometer": () => Promise.resolve().then(() => (init_odometer(), odometer_exports)),
  "pause": () => Promise.resolve().then(() => (init_pause(), pause_exports)),
  "picture-in-picture-exit": () => Promise.resolve().then(() => (init_picture_in_picture_exit(), picture_in_picture_exit_exports)),
  "picture-in-picture": () => Promise.resolve().then(() => (init_picture_in_picture(), picture_in_picture_exports)),
  "play": () => Promise.resolve().then(() => (init_play(), play_exports)),
  "playback-speed-circle": () => Promise.resolve().then(() => (init_playback_speed_circle(), playback_speed_circle_exports)),
  "playlist": () => Promise.resolve().then(() => (init_playlist(), playlist_exports)),
  "previous": () => Promise.resolve().then(() => (init_previous(), previous_exports)),
  "question-mark": () => Promise.resolve().then(() => (init_question_mark(), question_mark_exports)),
  "queue-list": () => Promise.resolve().then(() => (init_queue_list(), queue_list_exports)),
  "radio-button-selected": () => Promise.resolve().then(() => (init_radio_button_selected(), radio_button_selected_exports)),
  "radio-button": () => Promise.resolve().then(() => (init_radio_button(), radio_button_exports)),
  "repeat-on": () => Promise.resolve().then(() => (init_repeat_on(), repeat_on_exports)),
  "repeat-square-on": () => Promise.resolve().then(() => (init_repeat_square_on(), repeat_square_on_exports)),
  "repeat-square": () => Promise.resolve().then(() => (init_repeat_square(), repeat_square_exports)),
  "repeat": () => Promise.resolve().then(() => (init_repeat(), repeat_exports)),
  "replay": () => Promise.resolve().then(() => (init_replay(), replay_exports)),
  "rotate": () => Promise.resolve().then(() => (init_rotate(), rotate_exports)),
  "search": () => Promise.resolve().then(() => (init_search(), search_exports)),
  "seek-backward-10": () => Promise.resolve().then(() => (init_seek_backward_10(), seek_backward_10_exports)),
  "seek-backward-15": () => Promise.resolve().then(() => (init_seek_backward_15(), seek_backward_15_exports)),
  "seek-backward-30": () => Promise.resolve().then(() => (init_seek_backward_30(), seek_backward_30_exports)),
  "seek-backward": () => Promise.resolve().then(() => (init_seek_backward(), seek_backward_exports)),
  "seek-forward-10": () => Promise.resolve().then(() => (init_seek_forward_10(), seek_forward_10_exports)),
  "seek-forward-15": () => Promise.resolve().then(() => (init_seek_forward_15(), seek_forward_15_exports)),
  "seek-forward-30": () => Promise.resolve().then(() => (init_seek_forward_30(), seek_forward_30_exports)),
  "seek-forward": () => Promise.resolve().then(() => (init_seek_forward(), seek_forward_exports)),
  "send": () => Promise.resolve().then(() => (init_send(), send_exports)),
  "settings-menu": () => Promise.resolve().then(() => (init_settings_menu(), settings_menu_exports)),
  "settings-switch": () => Promise.resolve().then(() => (init_settings_switch(), settings_switch_exports)),
  "settings": () => Promise.resolve().then(() => (init_settings(), settings_exports)),
  "share-arrow": () => Promise.resolve().then(() => (init_share_arrow(), share_arrow_exports)),
  "share": () => Promise.resolve().then(() => (init_share(), share_exports)),
  "shuffle-on": () => Promise.resolve().then(() => (init_shuffle_on(), shuffle_on_exports)),
  "shuffle": () => Promise.resolve().then(() => (init_shuffle(), shuffle_exports)),
  "stop": () => Promise.resolve().then(() => (init_stop(), stop_exports)),
  "subtitles": () => Promise.resolve().then(() => (init_subtitles(), subtitles_exports)),
  "sun": () => Promise.resolve().then(() => (init_sun(), sun_exports)),
  "theatre-mode-exit": () => Promise.resolve().then(() => (init_theatre_mode_exit(), theatre_mode_exit_exports)),
  "theatre-mode": () => Promise.resolve().then(() => (init_theatre_mode(), theatre_mode_exports)),
  "thumbs-down": () => Promise.resolve().then(() => (init_thumbs_down(), thumbs_down_exports)),
  "thumbs-up": () => Promise.resolve().then(() => (init_thumbs_up(), thumbs_up_exports)),
  "timer": () => Promise.resolve().then(() => (init_timer(), timer_exports)),
  "transcript": () => Promise.resolve().then(() => (init_transcript(), transcript_exports)),
  "tv": () => Promise.resolve().then(() => (init_tv(), tv_exports)),
  "user": () => Promise.resolve().then(() => (init_user(), user_exports)),
  "volume-high": () => Promise.resolve().then(() => (init_volume_high(), volume_high_exports)),
  "volume-low": () => Promise.resolve().then(() => (init_volume_low(), volume_low_exports)),
  "x-mark": () => Promise.resolve().then(() => (init_x_mark(), x_mark_exports))
};

exports.lazyPaths = lazyPaths;
exports.paths = paths;
