import { signal, computed, onError, peek, setContext, getScope, getContext } from '@maverick-js/signals';
...
function provideContext(context, value, scope = getScope()) {
  ...
  setContext(context.id, hasProvidedValue ? value : (_a = context.provide) == null ? void 0 : _a.call(context), scope);
}
