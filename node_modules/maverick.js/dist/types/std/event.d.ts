...
import { type Dispose, type JSX, ReadSignal } from '../runtime';
 ...
 */
export declare function createEvent<Target extends EventTarget, Events = Target extends HTMLCustomElement<any, infer ElementEvents> ? ElementEvents : Record<string, DOMEventInit>, EventType extends keyof Events = keyof Events>(target: Target | null | ReadSignal<Target | null>, event: EventType, ...init: InferEventDetail<Events[EventType]> extends void | undefined | never ? [init?: Partial<InferEventInit<Events[EventType]>>] : [init: InferEventInit<Events[EventType]>]): Events[EventType];
/**
 ...
 */
export declare function dispatchEvent<Target extends EventTarget, Events = Target extends HTMLCustomElement<any, infer ElementEvents> ? ElementEvents : Record<string, DOMEventInit>, EventType extends keyof Events = keyof Events>(target: Target | null, event: EventType, ...init: InferEventDetail<Events[EventType]> extends void | undefined | never ? [init?: Partial<InferEventInit<Events[EventType]>>] : [init: InferEventInit<Events[EventType]>]): boolean;
/**
 ...
 */
export declare function listenEvent<Target extends EventTarget, Events = Target extends HTMLCustomElement<any, infer Events> ? Events & MaverickOnAttributes : MaverickOnAttributes, EventType extends keyof Events = keyof Events>(target: Target, type: EventType, handler: JSX.TargetedEventHandler<Target, Events[EventType] extends Event ? Events[EventType] : Event>, options?: AddEventListenerOptions | boolean): Dispose;
